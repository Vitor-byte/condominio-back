...
router.get("/chamado/resposta/:id", new chamado_controlador_1.chamadoControlador().consultaResposta);
router.get("/chamado/:id", new chamado_controlador_1.chamadoControlador().consultaIdChamado);
...
router.patch("/chamado/atender", new chamado_controlador_1.chamadoControlador().atender);
router.get("/chamado/usuario/:id", new chamado_controlador_1.chamadoControlador().consultaUsuario);
...
router.get("/enquete/verifica/:id", new enquete_controlador_1.enqueteControlador().verificaVoto);
//Area
...
//Reserva
router.get("/horarios/:data", new area_controlador_1.areaControlador().consultarHorario);
