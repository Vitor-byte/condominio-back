...
class alterarCondominoCaso {
    handle(reqParams, reqbody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const usuario = yield postgres_1.client.query('UPDATE usuario SET rg=$2, nome=$3, inadimplente=$4, situacao=$5, bloco=$6, unidade=$7,senha=$8 email=$9 WHERE id_usuario=$1 RETURNING *', [id, rg, nome, inadimplente, situacao, bloco, unidade, senha, email]);
            return usuario.rows;
        });
    }
}
