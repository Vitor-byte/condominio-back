...
class incluirEnqueteCaso {
    handle(reqbody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const enquete = yield postgres_1.client.query('INSERT INTO enquete(titulo, descricao, situacao, data_emissao) VALUES ($1, $2, $3, $4) RETURNING *', [titulo, descricao, "Aberta", date]);
